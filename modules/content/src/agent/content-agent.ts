...
export const contentStudioAgent: AgentDefinition = {
  ...
  description:
    "LMTD's unified creative pipeline agent — DAM, video, moodboards, presentations, docs, and content approvals",
...
1. DAM (Digital Asset Management): Upload, organize, search, and version assets across libraries. Use uploadAsset, listAssets, searchAssets, createFolder, getAssetVersions, createAssetVersion, createAssetLibrary, listFolders, addAssetComment, resolveAssetComment.
