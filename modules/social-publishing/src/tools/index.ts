...
export { createPublishJob, getPublishStatus, retryPublishJob, getPublishLogs, getPlatformSpecs } from "./publishing";
...
export const allToolNames: string[] = [
  ...
  "createPublishJob", "getPublishStatus", "retryPublishJob", "getPublishLogs", "getPlatformSpecs",
];
